...
<head runat="server">
    ...
    <link href="Content/wobstyles.css" rel="stylesheet" />
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.6/umd/popper.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.2.1/js/bootstrap.min.js"></script>
    <script src="script.js" type="text/javascript"></script>
    <title>SRN - TOP 10</title>
    <link rel="shortcut icon" type="image/png" href="Logos/Mightymouth_SRN_lowres.png"/>
</head>
                                ...
                                <div class="col-xs-10">
                                    <div class="container-bigLogo">
                                        <span class="container-helper-bigLogo">
                                            <a href="bowDefault.aspx" class="logoButton"><img class="bigLogo black" src="Logos/Mightymouth_SRN_short.png" alt="SRN Logo" /></a>
                                        </span>
                                    </div>
                                </div>
                                <div class="col-xs-1"></div>
                                ...
                                <div class="col-xs-12">
                                    <div id="container-header-top10" class="hidden">
                                        <span id="lolAnotherContainer-top10">
                                            <img class="headerImage SRN black" src="Headers/top10 too big glow.png" alt="SRN TOP 10 - TE TEKAU O RUNGA" />
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-xs-12">
                                    <div id="container-header-hitPicks" class="hidden">
                                        <div id="lolAnotherContainer-hitPicks">
                                            <img class="headerImage HitPicks black" src="Headers/hitPicks too big glow.png" alt="HIT PICKS" />
                                        </div>
                                    </div>
                                </div>
                            </div>
